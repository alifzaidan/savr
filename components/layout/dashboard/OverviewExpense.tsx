...
export default function OverviewExpense() {
    return (
        <Card className="flex flex-col gap-4 p-6 border border-border rounded-xl">
            <div className="flex-grow">
                ...
                <h3 className="font-amstelvar text-2xl">Rp. 600.000</h3>
                ...
                <div>
                    <DetailAnalytics title="Makan" amount={1000000} percentage={10} />
                    <Separator className="my-4" />
                    <DetailAnalytics title="Kebutuhan" amount={1000000} percentage={10} />
                </div>
            </div>
